...
Run the first AtFlows start command from the repository root. Then change to `examples/ai-sdk-proxy/` before running this example's install and run commands.
