...
| -------------------------------- | -------------------------------- | ------------------------------------------------------------------------ |
| [langchain](../../examples/langchain)         | LangChain.js via AtFlows proxy   | Basic tracing                                                            |
| [ai-sdk-proxy](../../examples/ai-sdk-proxy)   | Vercel AI SDK via AtFlows proxy  | Basic tracing                                                            |
| [vercel-ai-sdk](../../examples/vercel-ai-sdk) | Vercel AI SDK via proxy          | Basic tracing                                                            |
| [rag-pipeline](../../examples/rag-pipeline)   | RAG pipeline with AtFlows SDK    | **Hierarchical spans**, parent-child relationships, input/output capture |
...
| `ATFLOW_URL`    | No       | AtFlows dashboard URL (default: `http://localhost:1337`) |
...
4. Add a guide under `docs/integrations/` and a short `README.md` linking to it
