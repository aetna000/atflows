...
Run the first AtFlows start command from the repository root. Then change to `examples/vercel-ai-sdk/` before running this example's install and run commands.
