...
Commands that reference local files must be run from `examples/observability/jaeger/` in the repository root. Check the actual AtFlows dashboard URL shown at startup.
