...
Commands that reference local files must be run from `examples/observability/helicone/` in the repository root. Check the actual AtFlows dashboard URL shown at startup.
