...
remain unknown. The evaluator's budget ledger does not fill gaps in this product.

The four-arm native public-pilot replay checks that integration preserves the
original conversation and tool results; it is not a fresh task-success result.
Fresh faulted/held-out evaluations remain separate gates in Spec 010 P105.
