...
The planned OpenClaw integration should add OTLP/protobuf ingestion or a validated bridge, correlate OpenClaw sessions with AtFlows traces, and verify content redaction and cost fields. See [OpenClaw's OTLP setup](https://docs.openclaw.ai/gateway/opentelemetry/setup) and the [AtFlows architecture pathway](../../docs/architecture-roadmap.md).
